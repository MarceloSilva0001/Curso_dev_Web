...
//Essa função verifica se o valor está dentro de vetor, se o valor digitado for diferente de -1(valor dado quando o valor digitado não tem indice valido, indice valido começa apartir de 0 e vai somando)
function  inlist(n,l){
