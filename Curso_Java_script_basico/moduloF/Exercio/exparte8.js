...
//declaração de vetor
let valores = [];
//a função verifica se o valor que está dentro de num está dentre 1 e 100, e retorna o valor "true" ou "false"
function  isNumero(n){
...
//Essa função verifica se o valor está que esta dentro de vetor, se o valor digitado for diferente de -1(valor dado quando o valor digitado não tem indice valido, indice valido começa apartir de 0 e vai somando)
function  inlist(n,l){
